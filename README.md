...
- <span style="color: rgb(191, 191, 191);">当副手手持<sup>[v11.23.3]</sup>或被置于任意物品展示框中时，将会聚集周围 33x33x33 范围内的物品到其自身位置。</span>
...
- 礼物加入：树叶<sup>[v11.9]</sup>、冰、浮冰、蓝冰。

**🌹 嗅探兽**

- 刨挖加入：蒲公英、虞美人、兰花、绒球葱、蓝花美耳草、郁金香、滨菊、矢车菊、铃兰、张开的眼眸花、孢子花<sup>[v11.13]</sup>、枯萎的灌木<sup>[v11.23]</sup>。
...
- 平原村庄小屋加入：向日葵、玫瑰、牡丹、丁香、粉红色花簇<sup>[v11.23.1]</sup>、发光地衣<sup>[v11.23.4]</sup>。
- 沉船补给箱加入：苍白苔藓块<sup>[v11.23.4]</sup>、苍白垂须<sup>[v11.23.4]</sup>。
- 埋藏的宝藏加入：海龟蛋。
- 末地城宝藏加入：潜影壳。
- 金合欢村庄小屋加入：犰狳鳞甲。
