...
当遇到困难时，通过查阅并结合Minecraft wiki所描述的原版特性和下方介绍的核心特性，或许可以获取到有效的帮助。
...
- 当永夜骑士降临时，根据其降临时的边界等级，将额外提高其生命值。
- 当永夜骑士的周围不存在玩家时，永夜骑士将持续恢复生命值。
...
- 每当累计度过三次永恒之夜后，下次永恒之夜将会降临亡灵军团或灾厄军团。
- 每当累计度过八次永恒之夜后，下次永恒之夜将会降临永夜军团。
...
- 切灵以筑基石，示灵[以聚实物](https://www.mcmod.cn/class/18717.html)。
- 可通过切石机转换为基础建材。
...
- 礼物加入：枯萎的灌木[v11.10]、树叶[v11.9]、冰、浮冰、蓝冰。

**🌹 嗅探兽**

- 刨挖加入：蒲公英、虞美人、兰花、绒球葱、蓝花美耳草、郁金香、滨菊、矢车菊、铃兰、张开的眼眸花、孢子花[v11.3]。
...
**Q：如何更新整合包以获取最新版特性？**
- A：替换模组，保留原版本（推荐）：下载新版整合包 -> 使用PCL安装一个新版整合包作为临时版本 -> 删除原整合包版本mods目录中自带的模组文件 -> 将刚才安装的新整合包版本mods目录下的所有文件添加到原整合包版本的mods目录中。
