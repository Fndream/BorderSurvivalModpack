...
- ❌ **禁止**：在未经授权的情况下，您不可在任何公共场合（包括但不限于社区、网站、网盘、资源群、社交媒体等）上传、分享、发布本资源的原文件或经过修改后的文件。
- ❌ **禁止**：您不可将本资源用于任何商业目的，包括但不限于出售、捆绑销售、广告推广等。
- ❌ **禁止**：本系列不适用于服务器形式，您不可将本系列资源直接安装到服务器上供玩家强制下载或作为服务器核心玩法的一部分，使用服务端联机除外。
